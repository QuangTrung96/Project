                                ...
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1"
                                            ...
                                            style="width: 150px;text-align: center;">Name
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1"
                                            colspan="1" aria-label="Platform(s): activate to sort column ascending"
                                            style="width: 100px;text-align: center;">Parent ID
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1"
                                            colspan="1" aria-label="Platform(s): activate to sort column ascending"
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1"
                                            colspan="1" aria-label="Platform(s): activate to sort column ascending"
                                            style="width: 170px;text-align: center;">Slug
                                        </th>
                                        ...
                                        @if($categories)
                                            @foreach($categories as $key => $item)
                                                <tr style="text-align: center;">
                                                    ...
                                                    <td>{{ $item->slug }}</td>
                                                    <td>
                                                        <button class=" btn btn-success" style="float: left" ><a href="{{ url('admin/category/'.$item->id.'/edit') }}">Edit</a></button>
